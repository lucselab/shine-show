...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "See your changes instantly with our live preview as you build your portfolio"
    },
    {
  ...
  const testimonials = [
    {
      name: "Sarah Chen",
      role: "UX Designer",
      content: "This tool helped me create a stunning portfolio in minutes. The themes are gorgeous!",
      avatar: "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100"
    },
    {
      name: "Marcus Rodriguez",
      role: "Full Stack Developer",
      content: "The drag-and-drop interface is incredibly intuitive. I love how easy it is to customize.",
      avatar: "https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100"
    },
    {
      name: "Emily Watson",
      role: "Product Manager",
      content: "Professional results without the hassle. This is exactly what I needed for my career.",
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Create stunning, professional portfolios in minutes with our intuitive drag-and-drop builder. 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Shine</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our powerful yet simple tools help you create portfolios that get noticed by employers and clients.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Watch how easy it is to create a professional portfolio with our intuitive interface.
            </p>
          </div>
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border">
              <div className="bg-gray-100 px-6 py-4 border-b flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-600 font-medium">Portfolio Builder</span>
              </div>
              
              <div className="p-8">
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900">Editor Panel</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join thousands of professionals who've built amazing portfolios with our platform.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who've already built stunning portfolios. 
            Start creating yours today - it's completely free!
          </p>
          
          <button
            onClick={onGetStarted}
            className="group bg-white text-blue-600 px-10 py-5 rounded-xl font-bold text-xl hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center space-x-3 mx-auto"
          >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              The easiest way to create professional portfolios that get you hired.
            </p>
            
            <div className="border-t border-gray-800 pt-6">
              <p className="text-gray-500 text-sm">
                © 2025 Portfolio Builder. Built with ❤️ for professionals everywhere.
              </p>
            </div>
          </div>
        </div>
